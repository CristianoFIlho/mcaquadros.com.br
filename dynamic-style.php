  ...
  .woocommerce a.remove, .woocommerce a.remove:hover {color: #d71920 !important;}
  ...
  ::selection {background: #d71920;}
  ::-webkit-selection {background: #d71920;}
  ::-moz-selection {background: #d71920;}
  ::-o-selection {background: #d71920;}
  ::-ms-selection {background: #d71920;}
  ...
  .widget-tags a:hover, .widget_tag_cloud a:hover, .tagcloud a:hover,
  .woocommerce #review_form #respond .form-submit input:hover {border-color: #d71920;}


      blockquote {border-left-color: #d71920;}
  
  .slider .tooltip.bottom .tooltip-arrow {border-bottom-color: #d71920;}
...
.hanor-navi-wrap ul.dropdown-nav {
  ...
  .hanor-page-title {
    background-image: url(images/fundo_vermelho_nelmetais_1.jpg);  }
.no-class {}
